package com.metter.app.api.remote;
...
import com.metter.app.AppException;
import com.metter.app.api.ApiHttpClient;
import com.metter.app.bean.EventApplyData;
import com.metter.app.bean.NewsList;
import com.metter.app.bean.Report;
...
public class JsMetterApi {
     ...
     * @param handler
     */
    public static void login(String serviceip,String seriviceport,String servicename,String username, String password,
            AsyncHttpResponseHandler handler) {
        RequestParams params = new RequestParams();
        params.put("loginName", username);
        params.put("password", password);
       // params.put("keep_login", 1);
        String urlAddress = "http://"+serviceip+":"+seriviceport+"/"+servicename+"/android/getLogin.action";
        //String urlAddress = "EnergyManager/android/getLogin.action";//"action/api/login_validate";
        ApiHttpClient.post(urlAddress, params, handler);
    }

    public static void getMeterInfoList(String serviceIp, String servicePort,
			String serviceName, String fieldName, String fieldValue,
			AsyncHttpResponseHandler mHandler) {
    	RequestParams params = new RequestParams();
        params.put("fieldName", fieldName);
        params.put("fieldValue", fieldValue);
       // params.put("keep_login", 1);
        String urlAddress = "http://"+serviceIp+":"+servicePort+"/"+serviceName+"/android//getMeterInfo.action";
        //String urlAddress = "EnergyManager/android/getLogin.action";//"action/api/login_validate";
        ApiHttpClient.post(urlAddress, params, mHandler);

	}
    public static void getMeterDataList(String serviceIp, String servicePort,
			String serviceName, String fieldName, String fieldValue,
			AsyncHttpResponseHandler mHandler) {
    	RequestParams params = new RequestParams();
        params.put("fieldName", fieldName);
        params.put("fieldValue", fieldValue);
       // params.put("keep_login", 1);
        String urlAddress = "http://"+serviceIp+":"+servicePort+"/"+serviceName+"/android//getReport.action";
        //String urlAddress = "EnergyManager/android/getLogin.action";//"action/api/login_validate";
        ApiHttpClient.post(urlAddress, params, mHandler);

	}
    public static void getTreeList(String serviceip,String seriviceport,String servicename,String fieldName ,
    		String fieldValue,AsyncHttpResponseHandler handler){
    	RequestParams params = new RequestParams();
        params.put("fieldName", fieldName);
        params.put("fieldValue", fieldValue);
       // params.put("keep_login", 1);
        String urlAddress = "http://"+serviceip+":"+seriviceport+"/"+servicename+"/android//getOptions.action";
        //String urlAddress = "EnergyManager/android/getLogin.action";//"action/api/login_validate";
        ApiHttpClient.post(urlAddress, params, handler);
    }

	public static void exeCmd(String serviceip,String seriviceport,String servicename,String collector_no, String meter_no,
			String upSendCount, String tx,
			AsyncHttpResponseHandler handler) {
		RequestParams params = new RequestParams();
		params.put("imei", collector_no);
		params.put("meterId", meter_no);
		params.put("tx", tx);
		params.put("sendCount", upSendCount);
		String urlAddress = "http://"+serviceip+":"+seriviceport+"/"+servicename+"/android//exeCmd.action";
		ApiHttpClient.post(urlAddress, params, handler);

	}

	public static void exeForResoult(String serviceip,String seriviceport,String servicename,String collector_no, String meter_no,
			AsyncHttpResponseHandler handler) {
		RequestParams params = new RequestParams();
		params.put("imei", collector_no);
		params.put("meterId", meter_no);
		String urlAddress = "http://"+serviceip+":"+seriviceport+"/"+servicename+"/android//getExeResult.action";
		ApiHttpClient.post(urlAddress, params, handler);

	}

	public static void exeCmdGetGprsInfo(String serviceIp, String servicePort,String serviceName,
			AsyncHttpResponseHandler asyncHttpResponseHandler) {
		RequestParams params = new RequestParams();
		String urlAddress = "http://"+serviceIp+":"+servicePort+"/"+serviceName+"/android//getImei.action";
		ApiHttpClient.post(urlAddress, params, asyncHttpResponseHandler);

	}


	public static void exeReadMetersCmd(String serviceIp, String servicePort,
			String serviceName, String loginName, String string, String vals,
			AsyncHttpResponseHandler asyncHttpResponseHandler) {
		RequestParams params = new RequestParams();
		params.put("account", loginName);
		params.put("fieldName", string);
		params.put("fieldValue", vals);
		String urlAddress = "http://"+serviceIp+":"+servicePort+"/"+serviceName+"/android//readMeters.action";
		ApiHttpClient.post(urlAddress, params, asyncHttpResponseHandler);
